...
import { 
  LayoutDashboard, FileText, PieChart, Users, Trash2, Settings, 
  Menu, X, UserCircle 
} from "lucide-react";
...
export default function SidebarOwner() {
  ...
  const menuItems = [
    ...
    { name: "รายการลบล่าสุด", href: "/dashboard/deleted", icon: <Trash2 size={20} /> },
    { name: "สรุปยอดขาย", href: "/dashboard/summary", icon: <PieChart size={20} /> },
    { name: "ข้อมูลพนักงาน", href: "/dashboard/employee-info", icon: <Users size={20} /> },
    ...
    <>
      ...
      `}>
        ...
        <div className="flex-1 overflow-y-auto py-6 px-3 space-y-1">
            <p className="px-4 text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-2">เมนูเจ้าของร้าน</p>
